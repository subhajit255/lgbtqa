                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            Badge Style {{ !empty($details) ? 'Edit' : 'Add' }}</h1>
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('admin.badge-style.list') }}"
                                    class="text-muted text-hover-primary">Badge Style</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <div class="card">
                        <div class="card-body pt-6">
                            <div class="container">
                                <form id="badgeStyleForm" action="{{ route('admin.badge-style.add') }}" method="POST"
                                    class="formSubmit fileUpload" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="{{ $details->id ?? null }}">
                                    <div class="row pt-2">
                                        <div class="col-md-6">
                                            <label>
                                                <span class="label_title">Badge Icon</span>
                                            ...
                                            <div class="fv-row">
                                                @if (!empty($details->icon))
                                                    <style>
                                                        .image-input-placeholder {
                                                            background-image: url('{{ $details->icon_path }}');
                                                        }
                                                    </style>
                                                @else
                                                    <style>
                                                ...
                                                <div class="image-input image-input-empty image-input-outline image-input-placeholder"
                                                    ...
                                                    <label
                                                        ...
                                                        <input type="file" name="file" accept=".png, .jpg, .jpeg, .svg, .webp"
                                                            id="file" />
