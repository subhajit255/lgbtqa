        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <div class="card">
                        <div class="card-body">
                            <form id="groupForm" class="formSubmit fileUpload" action="{{ route('admin.groups.store') }}"
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <textarea class="form-control" rows="3" name="description" placeholder="Group description"></textarea>
                                </div>
                                <div class="row g-9 mb-8">
                                    <div class="col-md-6 fv-row">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control" name="tags"
                                            placeholder="dating, making friends, etc" />
                                    </div>
                                </div>
                                <div class="row g-9 mb-8">
                                    <div class="col-md-6 fv-row">
                                        <div class="form-check form-switch form-check-custom form-check-solid">
                                            ...
                                            <label class="form-check-label fw-semibold fs-6" for="is_public">Public Group
                                                (Discoverable)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <button type="submit" id="submitBtn" class="btn btn-primary">
                                        <span class="indicator-label">Create Group</span>
