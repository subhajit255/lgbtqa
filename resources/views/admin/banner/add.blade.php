            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Banner {{ !empty($details) ? 'Edit' : 'Add' }}</h1>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    <div class="card-body pt-6">
                        <div class="container">
                            <form id="bannerForm" action="{{ route('admin.banner.add') }}" method="POST" class="formSubmit fileUpload" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 pt-4">
                                                <div class="form-group">
                                                    <label for="url" class="label-style">Url</label>
                                                    <input type="text" class="form-control" placeholder="Enter Name" name="url" id="url" value="{{ $details->url ?? null }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
