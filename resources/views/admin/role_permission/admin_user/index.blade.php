                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">Admin User</li>
                        </ul>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <button type="button" class="btn btn-dark goTo"
                                data-action="{{ route('admin.role.user.add') }}">Add
                                User</button>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @forelse ($details as $detail)
                                        <tr>
                                            ...
                                            <td>{{ $detail->roles()->first()->name ?? 'N/A' }}</td>
                                            ...
                                            <td class="text-center"><a href="javascript:void(0)" class="goTo"
                                                    data-action="{{ route('admin.role.user.permission', $detail->uuid) }}"><i
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a class="menu-link px-3"
                                                            href="{{ route('admin.role.user.add', $detail->uuid) }}">Edit</a>
                                                    </div>
                                                    <div class="menu-item px-3">
